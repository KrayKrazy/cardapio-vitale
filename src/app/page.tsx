    ...
    <div className="min-h-screen pb-40 font-sans bg-[#030303] text-white selection:bg-red-600/30 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <header className="relative w-full h-72 sm:h-80 flex flex-col justify-end p-6 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-t from-[#030303] via-[#030303]/60 to-transparent z-10"></div>
            ...
            <div className="bg-[#111] w-full max-w-md sm:rounded-[2rem] rounded-t-[2rem] shadow-2xl animate-in slide-in-from-bottom-full duration-300 max-h-[90vh] flex flex-col relative z-10 border border-white/10">
              ...
              <div className="p-6 overflow-y-auto hide-scrollbar -mt-10 relative z-10 flex-1">
                ...
                <button 
                  ...
                  className="w-full mt-6 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-black py-4 rounded-2xl shadow-[0_10px_30px_rgba(220,38,38,0.3)] transition-transform active:scale-[0.98] text-lg flex justify-between px-6 items-center border border-red-500/50"
                >
        ...
        {showCart && (
          <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center bg-black/60 backdrop-blur-md transition-all">
            ...
            <div className="bg-[#111] w-full max-w-md sm:rounded-[2rem] rounded-t-[2rem] shadow-2xl animate-in slide-in-from-bottom-full duration-300 max-h-[90vh] flex flex-col relative z-10 border border-white/10">
              ...
              {cart.length > 0 && (
                <div className="p-6 bg-gradient-to-t from-[#030303] to-[#111] border-t border-white/5">
                  ...
                  <button 
                    ...
                    disabled={isLoading}
                    className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-white font-black py-4 rounded-2xl shadow-[0_10px_30px_rgba(34,197,94,0.3)] transition-all active:scale-[0.98] text-lg flex items-center justify-center gap-2 border border-green-400/30"
                  >
            ...
            <div className="bg-[#111] w-full max-w-sm rounded-[2.5rem] p-8 text-center shadow-[0_0_80px_rgba(220,38,38,0.15)] border border-white/10 animate-in zoom-in-95 duration-500 relative overflow-hidden">
              ...
              <div className="mt-10 space-y-3 relative z-10">
                <button 
                  ...
                  className="w-full bg-yellow-400 hover:bg-yellow-300 text-black font-black py-4 rounded-2xl shadow-[0_10px_30px_rgba(250,204,21,0.3)] transition-all active:scale-[0.98] text-lg"
                >
                  Sim, eu quero!
                </button>
                <button 
